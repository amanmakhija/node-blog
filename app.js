...
app.get("/", function (req, res) {
  Blog.find({}, function (err, posts) {
    res.render("home", { homePageTitle: homeStartingContent, homePageText: homeStartingContent, posts: posts });
  });
});

app.get("/about", function (req, res) {
  res.render("about", { aboutPageTitle: aboutContent, aboutPageText: aboutContent });
});

app.get("/contact", function (req, res) {
  res.render("contact", { contactPageTitle: contactContent, contactPageText: contactContent });
});

app.get("/compose", function (req, res) {
  res.render("compose", { contactPageText: contactContent });
});
